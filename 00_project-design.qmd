...
knitr::kable(combined_results_clean, caption = "Table 4. Paired Logistic Regression Results", digits = 2, align = "c") %>%
kable_styling(full_width = FALSE) %>%
footnote(general = "Significance codes: *** p < 0.001, ** p < 0.01, * p < 0.05, . p < 0.1", general_title = "")
...
knitr::kable(combined_results2_clean, caption = "Table 5. Single-Predictor Logistic Regression Results", digits = 2, align = "c")%>%
kable_styling(full_width = FALSE) %>%
footnote(general = "Significance codes: *** p < 0.001, ** p < 0.01, * p < 0.05, . p < 0.1", general_title = "")
