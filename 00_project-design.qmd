...
knitr::kable(combined_results_clean, caption = "Table 6. Paired Logistic Regression Results", digits = 2, align = "c")
```
...
knitr::kable(combined_results2_clean, caption = "Table 7. Single-Predictor Logistic Regression Results", digits = 2, align = "c")
```
...
knitr::kable(AIC_BIC_table2, caption = "Table 8. AIC and BIC for Single-Predictor Models", digits = 2, align = "c")
```

Table 8 shows

```{r}
knitr::kable(AIC_BIC_table_paired, caption = "Table 9. AIC and BIC for Paired Models", digits = 2, align = "c")
```
