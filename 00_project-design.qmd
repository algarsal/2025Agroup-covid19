...
#chi_results
knitr::kable(chi_results, caption = "Table 1. Summary of Chi Square Tests", digits = 2, align = "c")
```

  Table 1 confirms that the presence of four comorbidities namely Diabetes, Hypertension, Obesity, or Smoking is significantly non-randomly associated with mortality. Hypertension displays the strongest statistical signal of association supporting their prioritization as critical risk factors.
