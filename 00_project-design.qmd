...
This comprehensive analysis elucidates the differential impact of common comorbidities on COVID-19 mortality. Hypertension was identified as the single most critical risk factor, demonstrating both the highest statistical robustness and the greatest incremental value for mortality prediction.
...
These findings support a risk-stratification strategy that prioritizes patients with Hypertension, particularly when comorbid with Obesity or Diabetes, for early intervention and intensive monitoring. Future research should focus on the mechanistic interactions between these comorbidities to further refine prognostic models.
