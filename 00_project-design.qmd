...
#10 Results Figures and tables with captions and description of what do they mean.Never include citations in this part.This is only your work.
  ...
  Figure 4: The GIV reflects the overall added predictive value contributed by each predictor across the full model.
Larger GIV values represent more influential predictors. Hypertension shows the highest average incremental value among predictor.
...
#chi_results
knitr::kable(chi_results, caption = "Summary of Chi Square Tests", digits = 2, align = "c")
```
...
MVM <- glm(COVID_Death ~ Diabetes + Hypertension + Obesity + Smoking,
                  ...
                  family = binomial)
#summary(MVM)
knitr::kable(tidy(MVM), caption = "Multivariable Model of Individual LRM", digits = 2, align = "c")
...
MVMwithCM <- glm(COVID_Death ~ Diabetes + Hypertension + Obesity + Smoking,
                  ...
                  family = binomial)
#summary(MVMwithCM)
knitr::kable(tidy(MVMwithCM), caption = "Multivariable Model with CM of Individual LRM", digits = 2, align = "c")
...
LRMnoCM <- glm(COVID_Death ~ 1,        
                ...
                family = binomial)
#summary(LRMnoCM)
knitr::kable(tidy(LRMnoCM), caption = "Mortality baseline (Deaths WITH OUT CM)", digits = 2, align = "c")
...
LRM_NCM <- glm(COVID_Death ~ Number_of_Comorbidities,
                 ...
                 family = binomial)
#summary(LRM_NCM)
knitr::kable(tidy(LRM_NCM), caption = "LRM Number of comorbidities", digits = 2, align = "c")
